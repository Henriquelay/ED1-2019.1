...
set ruler
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/vim-gitgutter,~/.vim/bundle/vim-surround,~/.vim/bundle/agit.vim,~/.vim/bundle/conque-shell,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/after,/usr/local/lib/python2.7/dist-packages/powerline/bindings/vim/,~/.vim/bundle/Vundle.vim,~/.vim/bundle/Vundle.vim/after,~/.vim/bundle/vim-gitgutter/after,~/.vim/bundle/vim-surround/after,~/.vim/bundle/agit.vim/after,~/.vim/bundle/conque-shell/after
set shiftwidth=4
set smartindent
set softtabstop=4
...
silent only
cd ~/Gits/ED1-Aulas/lab10\ analisando\ TADs/code
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 listaencadeada.c
badd +0 testLista.c
badd +0 listaencadeada.h
argglobal
silent! argdel *
$argadd listaencadeada.c
edit testLista.c
...
wincmd w
argglobal
if bufexists('listaencadeada.h') | buffer listaencadeada.h | else | edit listaencadeada.h | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
nmap <buffer> \hp <Plug>GitGutterPreviewHunk
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 50 - ((21 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
50
...
wincmd w
argglobal
if bufexists('listaencadeada.c') | buffer listaencadeada.c | else | edit listaencadeada.c | endif
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
nmap <buffer> \hp <Plug>GitGutterPreviewHunk
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 85 - ((15 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
