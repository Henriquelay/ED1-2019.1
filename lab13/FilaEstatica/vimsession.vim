...
silent only
cd ~/Gits/ED1-Aulas/lab13/FilaEstatica
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 FilaEstatica.c
badd +0 FilaEstatica.h
badd +0 main.c
argglobal
silent! argdel *
argadd FilaEstatica.c
edit main.c
...
exe '1resize ' . ((&lines * 20 + 26) / 53)
exe 'vert 1resize ' . ((&columns * 78 + 95) / 191)
exe '2resize ' . ((&lines * 30 + 26) / 53)
exe 'vert 2resize ' . ((&columns * 78 + 95) / 191)
exe 'vert 3resize ' . ((&columns * 112 + 95) / 191)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
silent! normal! zE
let s:l = 21 - ((16 * winheight(0) + 10) / 20)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 125 - ((0 * winheight(0) + 25) / 51)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
